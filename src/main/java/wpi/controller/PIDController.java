...
package wpi.controller;

import edu.wpi.first.hal.FRCNetComm.tResourceType;
import edu.wpi.first.hal.HAL;
import wpi.math.MathUtil;
import wpi.smartdashboard.Sendable;
import wpi.smartdashboard.SendableRegistry;
...
public class PIDController implements Sendable, AutoCloseable {
  ...
  public void initSendable(wpi.smartdashboard.SendableBuilder builder) {
